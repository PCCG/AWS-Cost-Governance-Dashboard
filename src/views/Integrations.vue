  ...
  <v-container fluid>
    <v-layout row wrap>
      ...
      <v-flex xs3 class="text-right">
        <i class="el-icon-plus primary-color clickable-icon" title="Add an AWS account" @click="integrateAccount = true" role="button"></i>
        <i class="el-icon-refresh primary-color clickable-icon" title="Refresh" @click="FETCH_AWS_ACCOUNTS" role="button"></i>
      ...
      <integrate-account v-if="integrateAccount" @close-dialog="integrateAccount = false" :integrateAccount="integrateAccount" :title="integrationDialogTitle"/>
    </v-layout>
  </v-container>
</template>
